...
<nav class="navbar navbar-inverse navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div class="container">
			...
			<p class="lead">The Complete Blog Using PHP by Sreejita Ghosh</p>
			</div>
			<div class="row">
				<div class="col-sm-8">
				<?php 
...
<form action="FullPost.php?id=<?php echo $PostId; ?>" method="post" enctype="multipart/form-data">
	<fieldset>
		...
		<br>
		 ...
		 <div id="Footer">	
		<hr><p>Theme by | Sreejita Ghosh |&copy;2016-2020 --- All right reserved.
		</p>
		<a style="color: white; text-decoration:none; cursor:pointer; font-weight:bold;" href="http:// google.com"
		<p>
This site is only used for study purpose Sreejita.com have all the rights.no one is allow
copies other than <br>&trade; Sreejita.com &trade; NS3 ; &trade; Skillshare; &trade;
</a>
